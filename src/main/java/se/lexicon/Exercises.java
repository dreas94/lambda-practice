...
public class Exercises {
    ...
    */
    public static void exercise1(String message){
        ...
        System.out.println(storage.findMany(person -> person.getFirstName().equalsIgnoreCase("Erik")).toString());
    ...
    public static void exercise2(String message){
        ...
        System.out.println(storage.findMany(person -> person.getGender() == Gender.FEMALE));
    ...
    public static void exercise3(String message){
        ...
        System.out.println(storage.findMany(person -> person.getBirthDate().isAfter(LocalDate.parse("2000-01-01"))));
    ...
    public static void exercise7(String message){
        ...
        System.out.println(storage.findManyAndMapEachToString(person -> Period.between(person.getBirthDate(), LocalDate.now()).getYears() < 10,
    ...
    public static void exercise8(String message){
        ...
        storage.findAndDo(person -> person.getFirstName().equalsIgnoreCase("Ulf"), System.out::println);
    ...
    public static void exercise10(String message){
        ...
        storage.findAndDo(person -> IntStream.range(0, person.getFirstName().toLowerCase().length() / 2).noneMatch(index -> person.getFirstName().toLowerCase().charAt(index) != person.getFirstName().toLowerCase().charAt(person.getFirstName().toLowerCase().length() - index - 1)), System.out::println);
